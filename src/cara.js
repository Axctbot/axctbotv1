...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp AXCT BOT
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Aidil
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig aidil.tipi
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & Aidil
➸ *${prefix}play*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta AXCT
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub AXCT & Hub
